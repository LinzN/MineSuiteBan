 ...
 */
package de.kekshaus.cookieApi.ban.utils;
...
public class TimeParser {
	...
	/**
	 * Parse a string input into milliseconds, using w(eeks), d(ays), h(ours),
	 * m(inutes) and s(econds) For example: 4d8m2s -> 4 days, 8 minutes and 2
	 * seconds
	 *
	 * @param string
	 *            String to convert to Seconds
	 * @return Seconds
	 */
